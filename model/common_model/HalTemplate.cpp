...
bool HalTemplate::validate(
  ...
  if (propertiesIsSet()) {
    const std::vector<ngkore::model::common::Property>& value = m_Properties;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const ngkore::model::common::Property& value : value) {
...
ngkore::model::common::HttpMethod HalTemplate::getMethod() const {
  return m_Method;
}
void HalTemplate::setMethod(ngkore::model::common::HttpMethod const& value) {
  m_Method = value;
}
...
std::vector<ngkore::model::common::Property> HalTemplate::getProperties() const {
  return m_Properties;
}
void HalTemplate::setProperties(
    std::vector<ngkore::model::common::Property> const& value) {
  m_Properties      = value;
