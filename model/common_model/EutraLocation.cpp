...
ngkore::model::common::Tai EutraLocation::getTai() const {
  return m_Tai;
}
void EutraLocation::setTai(ngkore::model::common::Tai const& value) {
  m_Tai = value;
}
...
ngkore::model::common::Ecgi EutraLocation::getEcgi() const {
  return m_Ecgi;
}
void EutraLocation::setEcgi(ngkore::model::common::Ecgi const& value) {
  m_Ecgi = value;
}
...
ngkore::model::common::GlobalRanNodeId EutraLocation::getGlobalNgenbId() const {
...
ngkore::model::common::GlobalRanNodeId EutraLocation::getGlobalENbId() const {
