...
bool SnssaiExtension::validate(
  ...
  if (sdRangesIsSet()) {
    const std::vector<ngkore::model::common::SdRange>& value = m_SdRanges;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const ngkore::model::common::SdRange& value : value) {
...
std::vector<ngkore::model::common::SdRange> SnssaiExtension::getSdRanges() const {
  return m_SdRanges;
}
void SnssaiExtension::setSdRanges(
    std::vector<ngkore::model::common::SdRange> const& value) {
  m_SdRanges      = value;
