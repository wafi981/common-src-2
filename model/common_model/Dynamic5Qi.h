...
class Dynamic5Qi {
 public:
  ...
  ///
  /// </summary>
  ngkore::model::common::QosResourceType getResourceType() const;
  void setResourceType(ngkore::model::common::QosResourceType const& value);
  /// <summary>
  ///
  /// </summary>
 ...
 protected:
  ngkore::model::common::QosResourceType m_ResourceType;
