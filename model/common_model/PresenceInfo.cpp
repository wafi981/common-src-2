...
ngkore::model::common::PresenceState PresenceInfo::getPresenceState() const {
...
std::vector<ngkore::model::common::Tai> PresenceInfo::getTrackingAreaList() const {
...
std::vector<ngkore::model::common::Ecgi> PresenceInfo::getEcgiList() const {
  return m_EcgiList;
}
...
std::vector<ngkore::model::common::Ncgi> PresenceInfo::getNcgiList() const {
  return m_NcgiList;
}
